                ...
                <div class="card-block card-dashboard">
                        <div class="table">
                            <div class="table-row">
                                    ...
                                    <div class="table-head-cell"><strong>고객</strong></div>
                            ...
                            <div class="table-row item" role="button" onclick="location.href='/deal/AdminDealDetail.do?deal_seq=<%=dDTO.getDeal_seq()%>&back=deal'">
