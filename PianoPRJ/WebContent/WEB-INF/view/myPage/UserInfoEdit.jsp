					...
					<div class="card-block">
						<form data-toggle="validator" role="form" name="form" class="form" action="/user/DoUserInfoEdit.do" method="post" autocomplete="off" onsubmit="doSubmit();">
								...
								<div class="col-xs-12 red" style="margin-bottom:1em">*표시된 항목은 필수 입력사항입니다.</div>
									...
									<div class="col-md-12">
										<div class="form-group has-feedback">
											...
											<input value="<%=CmmUtil.nvl(uDTO.getUser_nick(), true)%>" type="text" id="projectinput2" pattern="^[가-힣A-z0-9]{1,}$" class="form-control" placeholder="닉네임을 입력해주세요" name="user_nick" required data-pattern-error="한글, 영문 및 숫자만 가능합니다">
								...
								<div class="row">
									<div class="col-md-12">
										<div class="form-group has-feedback">
											...
											<input value="<%=CmmUtil.nvl( uDTO.getEmail(), true)%>" type="text" id="email" class="form-control" placeholder="이메일을 입력해주세요" name="email" pattern="^\w+([\.-]?\w+)*@\w+([\.-]?\w+)*(\.\w{2,3})+$" data-remote="/user/EditDupCheck.do" data-remote-error="이미 사용중인 이메일입니다"  required data-error="유효한 이메일 주소가 아닙니다">
											<span class="glyphicon form-control-feedback" aria-hidden="true"></span>
							...
							<button type="submit" class="btn btn-primary">
								...
								<button type="button" onclick="location.href='MyInfo.do'" class="btn btn-warning mr-1 d-flex">
