...
<section id="header-footer">
	...
	<div class="row">
				...
				<div class="card-body collapse in">
					<div class="card-block">
					<form onsubmit="return submitReq();" data-toggle="validator" enctype="multipart/form-data" role="form" name="regForm" class="form" action="/req/PrivateReqSubmit.do" method="post" autocomplete="off">
